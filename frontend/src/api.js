/**
 * FlipIQ API Client
 * Production-grade API module with centralized configuration
 */

import { API_URL, apiFetch, downloadFile } from './config'
import { useAuthStore } from './store/authStore'

// Re-export config for backward compatibility
export { API_URL, apiFetch, downloadFile }
 ...
 * Handles auth headers and 401 redirects
 */
